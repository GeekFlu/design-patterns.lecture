...
class HotDrinkMachine {
	...
	public HotDrinkMachine() throws Exception {
		...
		for (AvailableDrink drink : AvailableDrink.values()) {
			...
			Class<?> factory = Class.forName("mx.com.geekflu.design.pattern.factory." + factoryName + "Factory");
		...
		Set<Class<? extends IHotDrinkFactory>> types = new Reflections("mx.com.geekflu.design.pattern.factory") // ""
